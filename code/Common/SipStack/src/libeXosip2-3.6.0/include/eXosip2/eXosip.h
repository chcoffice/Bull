 ...
 */
  int eXosip_generate_random (char *buf, int buf_size MARGS);
 ...
 */
  sdp_message_t *eXosip_get_remote_sdp (int did MARGS);
 ...
 * @param did          dialog id of call.
 */
  sdp_message_t *eXosip_get_local_sdp (int did MARGS);
 ...
 * @param did          dialog id of call.
 */
  sdp_message_t *eXosip_get_previous_local_sdp (int did MARGS);
 ...
 */
  sdp_message_t *eXosip_get_remote_sdp_from_tid (int tid MARGS);
 ...
 * @param tid          transction id of transaction.
 */
  sdp_message_t *eXosip_get_local_sdp_from_tid (int tid MARGS);
 ...
 */
  sdp_message_t *eXosip_get_sdp_info (osip_message_t * message MARGS);
 ...
 */
  sdp_connection_t *eXosip_get_audio_connection (sdp_message_t * sdp MARGS);
 ...
 * @param sdp     sdp information.
 */
  sdp_media_t *eXosip_get_audio_media (sdp_message_t * sdp MARGS);
 ...
 * @param sdp     sdp information.
 */
  sdp_connection_t *eXosip_get_video_connection (sdp_message_t * sdp MARGS);
 ...
 * @param sdp     sdp information.
 */
  sdp_media_t *eXosip_get_video_media (sdp_message_t * sdp MARGS);
 ...
 */
  sdp_connection_t *eXosip_get_connection (sdp_message_t * sdp, const char *media MARGS);
 ...
 * @param media   media to search.
 */
  sdp_media_t *eXosip_get_media (sdp_message_t * sdp, const char *media MARGS);
 ...
 */
  void eXosip_event_free (eXosip_event_t * je MARGS);
 ...
 * 
 */
  int eXosip_event_geteventsocket (MARGS2);
  ...
  */
  eXosip_tls_ctx_error eXosip_set_tls_ctx (eXosip_tls_ctx_t * ctx MARGS);
...
/**
  ...
  *	@return  the eXosip_tls_ctx_error code
  */
  eXosip_tls_ctx_error eXosip_tls_use_server_certificate (const char *local_certificate_cn MARGS);
...
/**
  ...
  *         @return  the eXosip_tls_ctx_error code
  */
  eXosip_tls_ctx_error eXosip_tls_use_client_certificate (const char *local_certificate_cn MARGS);
...
/**
  ...
  *	@return  the eXosip_tls_ctx_error code
  */
  eXosip_tls_ctx_error eXosip_tls_verify_certificate (int _tls_verify_client_certificate MARGS);
