 ...
 */
  int eXosip_call_build_ack (int did, osip_message_t ** ack MARGS);
 ...
 */
  int eXosip_call_send_request (int did, osip_message_t * request MARGS);
 ...
 */
  int eXosip_transfer_send_notify (int did, int subscription_status, char *body MARGS);
 ...
 */
  int eXosip_call_find_by_replaces (char *replaces MARGS);
