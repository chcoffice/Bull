 ...
 * 
 */
  void eXosip_quit (eXosip_t *pEXosip);
...
#define eXosip_lock(  MARGS2 ) ;

#define eXosip_unlock(  MARGS2 ) ;
 ...
 */
int eXosip_dnsutils_dns_process(struct osip_naptr *output_record, int force MARGS);
 ...
 * @param output_record  result structure.
 */
  int eXosip_dnsutils_rotate_srv(struct osip_srv_record *output_record MARGS);
 ...
 */
  void eXosip_enable_ipv6 (int ipv6_enable MARGS);
...
#else
#define __eXosip_wakeup_event(MARGS2)   ;
#endif
 ...
 */
  int eXosip_transport_set (osip_message_t * msg, const char *transport  MARGS);
