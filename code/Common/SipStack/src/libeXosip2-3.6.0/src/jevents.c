...
static int
_eXosip_event_fill_messages(eXosip_event_t * je, osip_transaction_t * tr MARGS)
{
	int i;
										   ...
										   osip_transaction_t * tr MARGS)
{
	...
	if (jc == NULL)
		return NULL;
	eXosip_event_init(&je, type MPARAMS);
	if (je == NULL)
		return NULL;
	...
	_eXosip_event_fill_messages(je, tr MPARAMS);
	return je;
}
...
eXosip_event_t *eXosip_event_init_for_message(int type, osip_transaction_t * tr MARGS)
{
	eXosip_event_t *je;
				  ...
				  eXosip_dialog_t * jd, osip_transaction_t * tr MARGS)
{
	...
	je = eXosip_event_init_for_call(evt, jc, jd, tr MPARAMS);
...
eXosip_event_t *eXosip_event_wait(int tv_s, int tv_ms MARGS)
{
	...
	eXosip_retransmit_lost200ok( MPARAMS2);
