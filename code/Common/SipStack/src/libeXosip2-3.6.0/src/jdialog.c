...
int eXosip_call_dialog_find(int jid, eXosip_call_t ** jc, eXosip_dialog_t ** jd MARGS)
{
	if (jid <= 0)
...
int
eXosip_notify_dialog_find(int nid, eXosip_notify_t ** jn, eXosip_dialog_t ** jd MARGS)
{
	if (nid <= 0)
		return OSIP_BADPARAMETER;
...
int eXosip_dialog_set_200ok(eXosip_dialog_t * jd, osip_message_t * _200Ok MARGS)
{
	int i;
...
int eXosip_dialog_init_as_uac(eXosip_dialog_t ** _jd, osip_message_t * _200Ok MARGS)
{
	int i;
	eXosip_dialog_t *jd;
