...
void eXosip_subscribe_free(eXosip_subscribe_t * js MARGS)
{
	...
	if (js->s_inc_tr != NULL && js->s_inc_tr->orig_request != NULL
		...
		_eXosip_delete_nonce(js->s_inc_tr->orig_request->call_id->number MPARAMS);
		...
		_eXosip_delete_nonce(js->s_out_tr->orig_request->call_id->number  MPARAMS);
	...
	__eXosip_delete_jinfo(js->s_inc_tr MPARAMS);
	__eXosip_delete_jinfo(js->s_out_tr MPARAMS);
	if (js->s_inc_tr != NULL)
...
_eXosip_subscribe_set_refresh_interval(eXosip_subscribe_t * js,
									   osip_message_t * out_subscribe MARGS)
{
	osip_header_t *exp;
