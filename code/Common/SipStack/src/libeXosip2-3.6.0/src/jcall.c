...
void eXosip_call_free(eXosip_call_t * jc  MARGS)
{
	...
	if (jc->c_inc_tr != NULL && jc->c_inc_tr->orig_request != NULL
		...
		_eXosip_delete_nonce(jc->c_inc_tr->orig_request->call_id->number MPARAMS);
		...
		_eXosip_delete_nonce(jc->c_out_tr->orig_request->call_id->number MPARAMS);
	...
	__eXosip_delete_jinfo(jc->c_inc_tr MPARAMS);
	__eXosip_delete_jinfo(jc->c_out_tr MPARAMS);
	if (jc->c_inc_tr != NULL)
