...
int eXosip_options_send_request(osip_message_t * options MARGS)
{
	osip_transaction_t *transaction;
	osip_event_t *sipevent;
	int i;

	i = _eXosip_transaction_init(&transaction, NICT, eXosip.j_osip, options MPARAMS);
	if (i != 0) {
...
int eXosip_options_build_answer(int tid, int status, osip_message_t ** answer MARGS)
{
...
int eXosip_options_send_answer(int tid, int status, osip_message_t * answer MARGS)
{
	osip_transaction_t *tr = NULL;
