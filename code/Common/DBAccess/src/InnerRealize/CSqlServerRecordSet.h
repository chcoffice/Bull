#ifndef CSQLSERVERRECORDSET_DEF_H
#define CSQLSERVERRECORDSET_DEF_H
...
File name 	: CSQLSERVERRECORDSET.H      
Author		: liujs     
Version 		: Vx.xx        
DateTime 		: 2010/6/7 16:30
Description 	: Sql Server 数据库数据集对象
**************************************************************************************************/
namespace	DBAccessModule
{

	class CSqlServerRecordSet :	public CRecordSet
	{
	public:
		CSqlServerRecordSet(void);
		virtual ~CSqlServerRecordSet(void);
	...
	public:
		...
		//----------------------------------------------------------------------------------
		// 设置连接对象
		BOOL			SetConnection(CSqlServerConnection* pConnection);
	...
	protected:	
		// Oracle连接对象
		CSqlServerConnection*	    m_pConnection;
	#if 0
		// ADO数据集
...
#endif // CSQLSERVERRECORDSET_DEF_H
