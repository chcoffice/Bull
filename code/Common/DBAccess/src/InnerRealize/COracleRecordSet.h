#ifndef CORACLERECORDSET_DEF_H
#define CORACLERECORDSET_DEF_H
...
File name : CORACLERECORDSET.H      
Author : liujs     
Version : Vx.xx        
DateTime : 2010/5/22 14:39
Description :   
ORACLE 数据集返回对象
**************************************************************************************************/
...
#define ERRNO_NETWORK_DISCNN 3114 //网络丢失连接
#define ERRNO_NETWORK_LOSTCNN 3135 //网络丢失连接

	class COracleRecordSet :public CRecordSet
	{
	public:
		COracleRecordSet(void);
		virtual ~COracleRecordSet(void);
	...
	public:
		...
		//----------------------------------------------------------------------------------
		// 设置连接对象
		BOOL			SetConnection(COracleConnection* pConnection);
