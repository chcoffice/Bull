/*******************************************************************************
  ...
  File name   : AUDIOENCDECDEF.H      
  Author      : jiangsx      
  Version     : Vx.xx        
  DateTime    : 2011/12/30 17:36
  Description : 音频格式编解码函数定义
*******************************************************************************/
#ifndef AUDIOENCDECDEF_DEF_H
#define AUDIOENCDECDEF_DEF_H


const unsigned char _l2u[4096] = {
...
inline unsigned char linear2ulaw(signed short l)
{
	unsigned char	mask;
...
inline unsigned char linear2alaw(signed short l)
{
	unsigned char	mask;
...
inline signed short	ulaw2linear(unsigned char u)
{
	return(_u2l[u]);
}

inline signed short	alaw2linear(unsigned char a)
{
	return(_A2l[a]);
}

inline unsigned char ulaw2alaw(unsigned char u)
{
	return(_u2A[u]);
}

inline unsigned char alaw2ulaw(unsigned char a)
{
	return(_A2u[a]);
}

inline int	g711a_Encode( char *src, char *dest, int srclen, int *dstlen)
{
	int	i,tmp;
	//	char dest_data;
...
inline int g711a_Decode( unsigned char *src, char *dest, int srclen, int *dstlen )
{
	int	i;
	unsigned short *pd=(unsigned short*)dest;
	for(i=0; i<srclen; i++)
	{	
		pd[i]= alaw2linear(src[i]);
	}
	*dstlen = srclen<<1;
...
inline int g711u_Decode( unsigned char *src, char *dest, int srclen, int *dstlen)
{
	int	i;
	unsigned short *pd=(unsigned short*)dest;
	for(i=0; i<srclen; i++)
...
inline int	g711u_Encode( char *src, char *dest, int srclen, int *dstlen)
{
	int	i,tmp;
	//	signed short src_data;
	//	unsigned char	mask;
